		...
		<header class="<?php lightning_the_class_name( 'entry-header' ); ?>">
			...
			<div class="<?php lightning_the_class_name( 'entry-body' ); ?>">
				<div class="detail_box">
					<h3>概要</h3>
					<div>
						<?php the_field('cf_summary') ?>
					</div>
				</div>
				<div class="detail_box">
					<h3>支援内容</h3>
					<div>
						<?php the_field('cf_content') ?>
					</div>
				</div>
				<div class="detail_box">
					<h3>対象者</h3>
					<div>
						<?php the_field('cf_target_person') ?>
					</div>
				</div>
				<div class="detail_box">
					<h3>申請方法</h3>
					<div>
						<?php the_field('cf_apply') ?>
					</div>
				</div>
				<div class="detail_box">
					<h3>問合せ先</h3>
					<div>
						<?php the_field('cf_contact') ?>
					</div>
				</div>
				<div class="detail_box">
					<h3>関連URL</h3>
					...
					<div>
						<?php the_field('cf_refer') ?>
					</div>
				</div>
				<div class="detail_box">
					<h3>管轄</h3>
					<div>
						<?php the_field('cf_org') ?>
					</div>
				</div>
			</div>
